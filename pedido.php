...
<html>
<head>
	<title>Administradora Universal</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="main-content">
		<div class="content-page">
			...
			<div class="p-line"><div>N° de Cuenta:</div>111-11111111-111</div>
			<div class="p-line"><div>Representante:</div>Encargado de ventas</div>
			<p><b>NOTA:</b> Para confirmar la compra debe realizar el deposito por le monto total, y enviar el comprobante al siguiente correo carlosjiovannichavez@gmail.com o al número de whatsapp 5564392516</p>
		</div>
	</div>
